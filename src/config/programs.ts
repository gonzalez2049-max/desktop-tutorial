...
export const DEFAULT_PROGRAMS: Record<ReportType, ProgramConfig> = {
  ...
  IAAS: {
    ...
    audits: [
      ...
      {
        ...auditTemplate('bundle_navm', 'Bundle NAVM', 'Cumplimiento del paquete de medidas (bundle) de prevención de neumonía asociada a ventilación mecánica', 'practicas'),
        goal: 95,
        formula: 'Cumplimiento = Cumple / (Cumple + No cumple) × 100, excluyendo N/A.',
        indicators: [
          // Núcleo de prevención de VAP (obligatorios)
          { name: 'Cabecera elevada 30–45° (posición semisentada)', kind: 'obligatorio' },
          { name: 'Higiene oral con clorhexidina', kind: 'obligatorio' },
          { name: 'Interrupción diaria de la sedación y evaluación de extubación', kind: 'obligatorio' },
          { name: 'Higiene de manos antes de manipular la vía aérea/circuito', kind: 'obligatorio' },
          { name: 'Presión del cuff mantenida en 20–30 cmH₂O', kind: 'obligatorio' },
          { name: 'Aspiración de secreciones subglóticas', kind: 'obligatorio' },
          { name: 'Manejo aséptico del circuito del ventilador', kind: 'obligatorio' },
          { name: 'Evaluación diaria de la posibilidad de retiro de la VM (weaning)', kind: 'obligatorio' },
          // Cuidado de soporte y registro (complementarios)
          { name: 'Profilaxis de úlcera péptica según indicación', kind: 'complementario' },
          { name: 'Profilaxis de trombosis venosa profunda (TVP) según indicación', kind: 'complementario' },
          { name: 'Verificación de posición y permeabilidad de la sonda enteral', kind: 'complementario' },
          { name: 'Registro de días de ventilación mecánica y del bundle', kind: 'complementario' },
        ],
        descriptiveVariables: ['Unidad', 'Turno', 'Estamento', 'Fecha'],
        breakdowns: [
          { key: 'estamento', label: 'Estamento', match: ['estamento', 'profesion', 'cargo', 'categoria'] },
        ],
        inclusion: ['Pacientes con ventilación mecánica invasiva, observados durante la atención.'],
        exclusion: ['Registros sin ítem del bundle identificado o sin resultado (Cumple / No cumple / N/A).'],
        kpis: ['Cumplimiento global del bundle', 'Cumplimiento por indicador', 'Cumplimiento por unidad', 'Cumplimiento por estamento'],
        charts: ['Velocímetro de cumplimiento global', 'Barras por indicador del bundle', 'Barras por unidad', 'Barras por estamento'],
        tables: [
          'Cumplimiento por indicador (bundle NAVM)',
          'Cumplimiento por unidad',
          'Cumplimiento por turno',
          'Cumplimiento por estamento',
        ],
        executiveText:
          'Informe de auditoría de cumplimiento del paquete de medidas (bundle) de prevención de neumonía asociada a ventilación mecánica. El cumplimiento oficial se calcula sobre los ítems obligatorios observados —Cumple / (Cumple + No cumple)—, excluyendo los no aplicables; los indicadores complementarios se informan aparte.',
        autoRecommendations: [
          { when: 'below_goal', text: 'Reforzar los elementos centrales del bundle (cabecera 30–45°, higiene oral con clorhexidina, interrupción diaria de la sedación con prueba de extubación y presión del cuff) mediante capacitación y verificación en terreno.' },
          { when: 'below_goal', text: 'Fortalecer la evaluación diaria de weaning y el manejo aséptico del circuito para reducir los días de ventilación mecánica y el riesgo de NAVM.' },
          { when: 'at_or_above_goal', text: 'Sostener el cumplimiento del bundle con auditorías periódicas y retroalimentación al equipo; documentar las prácticas que explican el buen resultado.' },
          { when: 'always', text: 'Asegurar la representatividad de las observaciones por unidad, turno y estamento, con observadores capacitados.' },
        ],
      },
